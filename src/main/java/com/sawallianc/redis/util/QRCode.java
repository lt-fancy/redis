package com.sawallianc.redis.util;
...
//        String text = "http://35.201.223.151/index.html";
//        FileOutputStream fos = new FileOutputStream(new File("C:/new.png"));
//        QRCode.encode(text,"C:/logo.png",fos,true);
//        UUID uuid = UUID.randomUUID();
//        System.out.println(uuid);
        System.out.println(decode(new File("C:\\guoxiaomei.png")));
    }
}
